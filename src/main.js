...
document.querySelector("#app").innerHTML = `
  <main class="app-shell">
    <header class="app-header">
      ...
      <div class="version-pill">v0.18 stable buttery feedback checkpoint</div>
    </header>
    ...
    <section class="panel patch-summary">
      ...
      <p id="patchSummaryText">Stable buttery feedback checkpoint. The v0.17 buttery feedback stage is frozen. No sound engine running. Press Start Oscillator or Start Noise to test one quiet source. Output is set to 70%, clamped to a safe maximum. Low-pass cutoff is set to 2600 Hz. Resonance is set to 0.7. Feedback is off. The feedback loop includes gentle internal soft saturation. The spectral meters listen after the master Output control. The spectral faders are visual only. No fake self-oscillation is connected.</p>
    </section>
  </main>
`;
...
function updatePatchSummary() {
  ...
  const feedbackCharacterText = "The v0.17 buttery feedback stage is frozen: the feedback loop uses gentle internal soft saturation to make feedback less brittle without adding a separate distortion effect.";
  ...
  patchSummaryText.textContent =
    `Stable buttery feedback checkpoint. The v0.17 buttery feedback stage is frozen. No sound engine running. Press Start Oscillator or Start Noise to test one quiet source. Output is set to ${outputPercent}%. ${feedbackSummary} ${safetyText} Low-pass cutoff is set to ${cutoffFrequency} Hz. Resonance is set to ${resonanceAmount}. ${feedbackCharacterText} ${spectralText} No fake self-oscillation is connected yet.`;
}
